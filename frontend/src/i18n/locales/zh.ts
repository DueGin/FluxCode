export default {
  ...
  redeem: {
    ...
    codeAlreadyUsed: '该兑换码已被使用',
    welfareAlreadyRedeemed: '该福利号已兑换过',
  ...
  admin: {
    ...
    accounts: {
      ...
      bulkActions: {
        ...
        clear: '清除选择',
        enableSchedulable: '开启调度',
        disableSchedulable: '关闭调度',
        refreshUsage: '刷新用量',
        resetTempUnschedulable: '重置临时不可调度',
        edit: '编辑账号',
        delete: '删除'
      },
      bulkEdit: {
      ...
      bulkSchedulableTitle: '批量设置调度状态',
      bulkSchedulableConfirmEnable: '确定要将选中的 {count} 个账号开启调度吗？',
      bulkSchedulableConfirmDisable: '确定要将选中的 {count} 个账号关闭调度吗？',
      bulkSchedulableSuccessEnable: '成功开启调度：{count} 个账号',
      bulkSchedulableSuccessDisable: '成功关闭调度：{count} 个账号',
      bulkSchedulablePartial: '部分设置成功：成功 {success} 个，失败 {failed} 个',
      bulkSchedulableFailed: '批量设置调度状态失败',
      bulkUsageRefreshSuccess: '用量刷新完成：{count} 个账号',
      bulkUsageRefreshPartial: '部分刷新完成：成功 {success} 个，失败 {failed} 个',
      bulkUsageRefreshFailed: '批量刷新用量失败',
      bulkUsageRefreshTitle: '批量刷新用量结果',
      bulkUsageRefreshSummary: '总计 {total}，成功 {success}，失败 {failed}',
      bulkUsageRefreshNoFailures: '全部刷新成功。',
      bulkUsageRefreshFailures: '失败明细（{count}）',
      bulkUsageRefreshAccountId: '账号 ID',
      bulkUsageRefreshAccountName: '账号',
      bulkUsageRefreshOutcome: '结果',
      bulkUsageRefreshDetail: '详情',
      bulkTempUnschedResetTitle: '批量重置临时不可调度',
      bulkTempUnschedResetConfirm: '确定要重置选中的 {count} 个账号的临时不可调度状态吗？',
      bulkTempUnschedResetSuccess: '临时不可调度已重置：{count} 个账号',
      bulkTempUnschedResetPartial: '部分重置成功：成功 {success} 个，失败 {failed} 个',
      bulkTempUnschedResetFailed: '批量重置临时不可调度失败',
      resetStatus: '重置状态',
      statusReset: '账号状态已重置',
    ...
    redeem: {
      ...
      isWelfare: '福利号',
      welfareNo: '福利号',
      welfareNoPlaceholder: '请输入福利号',
      welfareNoRequired: '请输入福利号',
      allWelfareNos: '全部福利号',
