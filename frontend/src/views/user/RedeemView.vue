...
const handleRedeem = async () => {
  ...
  try {
    ...
    if (error?.reason === 'WELFARE_ALREADY_REDEEMED') {
      errorMessage.value = t('redeem.welfareAlreadyRedeemed')
    } else if (error?.reason === 'REDEEM_CODE_USED') {
      errorMessage.value = t('redeem.codeAlreadyUsed')
    } else {
