		...
		},
		{
			...
			setup: func(t *testing.T, deps *contractDeps) {
				...
				deps.settingRepo.SetAll(map[string]string{
					...
					"redeem_delivery_text":         "发货文案：${redeemCodes}",
					service.SettingKeyAttractPopupTitle:    "Popup Title",
					service.SettingKeyAttractPopupMarkdown: "Popup Markdown",
			...
			wantJSON: `{
				...
				"data": {
					...
					"redeem_delivery_text": "发货文案：${redeemCodes}",
					"attract_popup_title": "Popup Title",
					"attract_popup_markdown": "Popup Markdown",
...
func (stubUserSubscriptionRepo) List(ctx context.Context, params pagination.PaginationParams, userID, groupID *int64, status string, userEmail string) ([]service.UserSubscription, *pagination.PaginationResult, error) {
	return nil, nil, errors.New("not implemented")
}
