...
func (r *stubUserSubscriptionRepo) List(ctx context.Context, params pagination.PaginationParams, userID, groupID *int64, status string, userEmail string) ([]service.UserSubscription, *pagination.PaginationResult, error) {
	return nil, nil, errors.New("not implemented")
}
...
func (r *stubUserSubscriptionRepo) BulkAdjustExpiryByGroupID(ctx context.Context, groupID int64, days int) ([]int64, error) {
	return nil, errors.New("not implemented")
}
