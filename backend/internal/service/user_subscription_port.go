...
type UserSubscriptionRepository interface {
	...
	List(ctx context.Context, params pagination.PaginationParams, userID, groupID *int64, status string, userEmail string) ([]UserSubscription, *pagination.PaginationResult, error)

	ExistsByUserIDAndGroupID(ctx context.Context, userID, groupID int64) (bool, error)
	ExtendExpiry(ctx context.Context, subscriptionID int64, newExpiresAt time.Time) error
	BulkAdjustExpiryByGroupID(ctx context.Context, groupID int64, days int) ([]int64, error)
